...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Προσθήκη τεχνητής καθυστέρησης για να φανεί το εφέ του loader.
        // Μπορείτε να αλλάξετε την τιμή '2000' (σε χιλιοστά του δευτερολέπτου).
        setTimeout(function() {
            if (loader) {
                // Ξεκινάει το fade-out του loader
                loader.style.opacity = '0';
                
                // Μετά από 500ms (όσο διαρκεί το fade-out animation), κρύβει τελείως τον loader
                // και εμφανίζει το κυρίως περιεχόμενο.
                setTimeout(function() {
                    loader.style.display = 'none';
                    if (content) {
                        content.style.display = 'flex';
                    }
                }, 500); // Αυτή η τιμή πρέπει να ταιριάζει με το 'transition' του CSS.
            }
        }, 2000); // 2000ms = 2 δευτερόλεπτα καθυστέρηση.
    });
</script>
"""
